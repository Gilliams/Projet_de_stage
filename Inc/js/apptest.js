...
const Categorie1 = {
    template: '<div>\
                    ...
                    <router-link :to="{name: \'Categorie1.Dossier1\'}"><button class="btn btn-primary">Acylic</button></router-link>\
                    <router-link :to="{name: \'Categorie1.Dossier2\'}"><button class="btn btn-primary">Alkane</button></router-link>\
